...
<div class="quotes-special_conditions">
    ...
    <table class="table table-striped table-bordered">
        ...
        <tr><td><?= $form->field($model, 'burglary_alarm_only')->checkbox() ?></td><td>2%</td></tr>
        <tr><td><?= $form->field($model, 'fire_resistive')->checkbox() ?></td><td>3%</td></tr>
        <tr><td><?= $form->field($model, 'sprinklered')->checkbox() ?></td><td>25%</td></tr>
        <tr><td><?= $form->field($model, 'fire_resistive_sprinklered')->checkbox() ?></td><td>35%</td></tr>
        <tr><td><?= $form->field($model, 'hood_and_duct')->checkbox() ?></td><td>50%</td></tr>
        <tr><td><?= $form->field($model, 'above')->checkbox() ?></td><td>10%</td></tr>
        <tr><td><?= $form->field($model, 'all_above')->checkbox() ?></td><td>15%</td></tr>
