    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            ['class' => 'yii\grid\ActionColumn',
                'header'=>'Actions',
                'template'=>'{view} {pdf} {excel}',
                'buttons'=>[
                    'pdf' => function ($url, $model) {
                        return Html::a('<img src="/images/icn_pdf.png">', $model->getPdfUrl(), [
                            'title' => Yii::t('yii', 'Download pdf version'),
                        ]);

                    },
                    'excel' => function ($url, $model) {
                        return Html::a('<img src="/images/icn_excel.gif">', $model->getCsvUrl(), [
                            'title' => Yii::t('yii', 'Download excel version'),
                        ]);
